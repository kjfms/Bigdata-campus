...
#### (1) 군집분석을 통한 행정동 선정
- 단일 예측 모형보다 더 나은 일반화된 결과를 도출하기 위해 K-means, K-mediods, GMM Clustering 모델을 활용해 군집분석 실시
  
#### (2) SNS 분석을 통한 핫플레이스 선정
- 닐슨 코리아 클릭의 '2021년 1분기 포털&SNS분석 보고서'에 따르면, MZ세대의 50% 이상이 사용하는 소셜미디어는 인스타그램임
- 이에 인스타그램의 게시글을 분석해 방문객이 많은 핫플레이스를 선정하고자 함  

#### (3) 핫플레이스 인근 지하철역 선정
- 핫플레이스 인근 지하철역 중, 공실이 존재하며 핫플레이스와의 접근성 측면에서 이점을 지닌 최종 입지 지하철역 선정

#### (4) 지하철 역사 내 현장조사
- 최종 입지로 선정된 지하철역에 방문해 지하철역의 구조와 
